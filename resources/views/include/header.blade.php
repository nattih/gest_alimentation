    ...
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          ...
          <li><a href="{{route('categorie')}}"><i class="bx bx-book-content"></i> <span>Categorie</span></a></li>
          <li><a href="{{route('produit')}}"><i class="bx bx-file-blank"></i> <span>Produit</span></a></li>
          <li><a href="#portfoli"><i class=" bx bx-user"></i>Client</a></li>
          <li><a href="{{route('vente.list')}}"><i class="bx bx-server"></i> Vente</a></li>
